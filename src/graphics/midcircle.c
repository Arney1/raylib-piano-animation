 ...
 */
void MidcircleThick(int centerX, int centerY, int radius, int thickness,
                    Color color) {
 ...
 */
void MidcircleDashed(int centerX, int centerY, int radius, int dashLen,
                     int gapLen, Color color) {
  if (radius <= 0) {
    DrawPixel(centerX, centerY, color);
    return;
  }
